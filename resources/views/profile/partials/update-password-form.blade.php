...
<section class="w-full p-6 !bg-[#D9D9D9] border border-black rounded-2xl shadow-none">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="relative">
            ...
            <x-text-input
                ...
                type="password"
                class="block w-full pl-10 py-3 !bg-[#D9D9D9] border border-black rounded-md placeholder-black focus:border-black focus:ring-black text-base"
        ...
        <div class="flex justify-center pt-4">
            <button type="submit"
                class="w-full sm:w-1/2 py-3 px-4 text-base font-bold rounded-2xl shadow-md shadow-black/60 bg-green-600 hover:bg-green-700 text-white transition-all duration-200">
                {{ __('Salvar') }}
            </button>
        </div>
