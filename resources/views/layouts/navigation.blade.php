<nav x-data="{ open: false }" class="bg-[#062035] text-white font-sans">
    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between h-24">
            ...
            <!-- Task 2: Contato WhatsApp (visível em telas médias e maiores) -->
            ...
            <!-- Task 3: Barra de Pesquisa (visível em telas grandes) -->
        ...
        <!-- Task 5: Botões de Navegação (visível em telas médias e maiores) -->
