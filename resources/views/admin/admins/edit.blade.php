...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 border-b-2 border-gray-600">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Editar Administrador</h1>
                <p class="text-sm text-gray-600 mt-1">Atualize os dados do usuário administrador</p>
            </div>
    ...
    <div class="p-6">
        ...
        <form method="POST" action="{{ route('admin.admins.update', $admin) }}" class="space-y-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg space-y-6">
                ...
                <p class="text-sm text-gray-500 -mt-4">Deixe os campos em branco para não alterar a senha.</p>
