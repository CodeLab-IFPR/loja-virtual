    ...
    <div class="p-6 border-b-2 border-gray-400">
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Atualize as informações da cor</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Slug atual: <code>{{ $color->slug }}</code></p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            class="px-4 py-3 mt-1 block w-full rounded-lg border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200">{{ old('description', $color->description) }}</textarea>
