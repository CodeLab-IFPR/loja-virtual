            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Slug atual: <code>{{ $category->slug }}</code></p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-1 text-sm text-gray-600">
                            ...
                            <p><strong>Última atualização:</strong> {{ $category->updated_at->format('d/m/Y H:i') }}</p>
                            <p><strong>Produtos:</strong> {{ $category->products()->count() }} item(s)</p>
                        </div>
                    </div>
                </div>
